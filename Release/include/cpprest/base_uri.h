...
namespace web {
    namespace details
    {
        struct uri_components
        {
            ...
            CPPRESTNATIVE_API utility::string_t join();
	...
	namespace 
	{
		class really_empty_uri_t {};
		really_empty_uri_t really_empty_uri;
	}
    ...
    public:
        ...
        CPPRESTNATIVE_API static utility::string_t __cdecl encode_uri(const utility::string_t &raw, uri::components::component = components::full_uri);
        ...
        /// </summary>
        /// <returns>The encoded string.</returns>
        CPPRESTNATIVE_API static utility::string_t __cdecl encode_data_string(const utility::string_t &data);
        ...
        CPPRESTNATIVE_API static utility::string_t __cdecl decode(const utility::string_t &encoded);
        ...
        CPPRESTNATIVE_API static std::vector<utility::string_t> __cdecl split_path(const utility::string_t &path);
        ...
        CPPRESTNATIVE_API static std::map<utility::string_t, utility::string_t> __cdecl split_query(const utility::string_t &query);
        ...
        CPPRESTNATIVE_API static bool __cdecl validate(const utility::string_t &uri_string);
		...
		/// <summary>
		/// Creates an really empty uri
		/// </summary>
		uri(really_empty_uri_t) {}
        ...
        CPPRESTNATIVE_API uri(const utility::char_t *uri_string);
        ...
        CPPRESTNATIVE_API uri(const utility::string_t &uri_string);
        ...
        CPPRESTNATIVE_API uri authority() const;
        ...
        CPPRESTNATIVE_API uri resource() const;
        ...
        CPPRESTNATIVE_API bool operator == (const uri &other) const;
    ...
    private:
        ...
        CPPRESTNATIVE_API uri(const details::uri_components &components);
