...
namespace web
{
    ...
    public:
        ...
        CPPRESTNATIVE_API uri_builder & set_port(const utility::string_t &port);
        ...
        CPPRESTNATIVE_API uri_builder &append_path(const utility::string_t &path, bool do_encoding = false);
        ...
        /// <param name="do_encoding">Specify whether to apply URI encoding to the given string.</param>
        /// <returns>A reference to this uri_builder to support chaining.</returns>
        CPPRESTNATIVE_API uri_builder &append_query(const utility::string_t &query, bool do_encoding = false);
        ...
        /// <returns>A reference to this uri_builder to support chaining.</returns>
        CPPRESTNATIVE_API uri_builder &append(const uri &relative_uri);
        ...
        CPPRESTNATIVE_API utility::string_t to_string() const;
        ...
        CPPRESTNATIVE_API uri to_uri() const;

        /// <summary>
        /// Validate the generated URI from all existing components of this uri_builder.
        /// </summary>
        /// <returns>Whether the URI is valid.</returns>
        CPPRESTNATIVE_API bool is_valid();

    private:
        CPPRESTNATIVE_API void append_query_encode_impl(const utility::string_t &name, const utf8string &value);
        CPPRESTNATIVE_API void append_query_no_encode_impl(const utility::string_t &name, const utility::string_t &value);
