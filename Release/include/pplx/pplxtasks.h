...
#define _PPLX_CAPTURE_CALLSTACK() ::pplx::details::_TaskCreationCallstack::_CaptureSingleFrameCallstack(_ReturnAddress())
#else
#define _PPLX_CAPTURE_CALLSTACK() ::pplx::details::_TaskCreationCallstack::_CaptureMultiFramesCallstack(PPL_TASK_SAVE_FRAME_COUNT)
#endif
#else
#define _PPLX_CAPTURE_CALLSTACK() ::pplx::details::_TaskCreationCallstack::_CaptureSingleFrameCallstack(_ReturnAddress())
#endif
...
namespace details
{
    ...
    {
        typedef decltype(::pplx::details::_ReturnTypeHelper(stdx::declval<_ExpectedParameterType>(),stdx::declval<_Function>(), 0, 0)) _FuncRetType;
        ...
        typedef decltype(::pplx::details::_IsTaskHelper(stdx::declval<_ExpectedParameterType>(),stdx::declval<_Function>(), 0, 0)) _Takes_task;
    };
...
public:
    ...
    {
        // It is important that _PPLX_CAPTURE_CALLSTACK() evaluate to the instruction after the call instruction for set_exception.
        return _Cancel(std::make_exception_ptr(_Except), _PPLX_CAPTURE_CALLSTACK());
    }
    ...
    /// </param>
    /**/
    __declspec(noinline) // Ask for no inlining so that the _PPLX_CAPTURE_CALLSTACK gives us the expected result
    ...
    {
        // It is important that _PPLX_CAPTURE_CALLSTACK() evaluate to the instruction after the call instruction for set_exception.
        return _Cancel(_ExceptionPtr, _PPLX_CAPTURE_CALLSTACK());
    }
...
public:
    ...
    bool set_exception(_E _Except) const // 'const' (even though it's not deep) allows to safely pass events by value into lambdas
    {
        return _M_unitEvent._Cancel(std::make_exception_ptr(_Except), _PPLX_CAPTURE_CALLSTACK());
    }
    ...
    /// </param>
    /**/
    __declspec(noinline) // Ask for no inlining so that the _PPLX_CAPTURE_CALLSTACK intrinsic gives us the expected result
    bool set_exception(std::exception_ptr _ExceptionPtr) const // 'const' (even though it's not deep) allows to safely pass events by value into lambdas
    {
        // It is important that _PPLX_CAPTURE_CALLSTACK() evaluate to the instruction after the call instruction for set_exception.
        return _M_unitEvent._Cancel(_ExceptionPtr, _PPLX_CAPTURE_CALLSTACK());
    }
...
public:
    ...
    explicit task(_Ty _Param)
    {
        ...
        // Do not move the next line out of this function. It is important that _PPLX_CAPTURE_CALLSTACK() evaluate to the the call site of the task constructor.
        _SetTaskCreationCallstack(_PPLX_CAPTURE_CALLSTACK());
    ...
    explicit task(_Ty _Param, const task_options &_TaskOptions)
    {
        ...
        _CreateImpl(_TaskOptions.get_cancellation_token()._GetImplValue(), _TaskOptions.get_scheduler());
        // Do not move the next line out of this function. It is important that _PPLX_CAPTURE_CALLSTACK() evaluate to the the call site of the task constructor.
        _SetTaskCreationCallstack(details::_get_internal_task_options(_TaskOptions)._M_hasPresetCreationCallstack ? details::_get_internal_task_options(_TaskOptions)._M_presetCreationCallstack : _PPLX_CAPTURE_CALLSTACK());
    ...
    {
        task_options _TaskOptions;
        details::_get_internal_task_options(_TaskOptions)._set_creation_callstack(_PPLX_CAPTURE_CALLSTACK());
        ...
        details::_TaskInliningMode_t _InliningMode = details::_ForceInline) const -> typename details::_ContinuationTypeTraits<_Function, _ReturnType>::_TaskOfType
    {
        ...
        return _ThenImpl<_ReturnType, _Function>(std::forward<_Function>(_Func), _PTokenState, task_continuation_context::use_default(), _Scheduler, _PPLX_CAPTURE_CALLSTACK(), _InliningMode);
    }
...
public:
    ...
    explicit task(_Ty _Param, const task_options& _TaskOptions = task_options())
    {
        ...
        // Do not move the next line out of this function. It is important that _PPLX_CAPTURE_CALLSTACK() evaluate to the the call site of the task constructor.
        _M_unitTask._SetTaskCreationCallstack(details::_get_internal_task_options(_TaskOptions)._M_hasPresetCreationCallstack ? details::_get_internal_task_options(_TaskOptions)._M_presetCreationCallstack : _PPLX_CAPTURE_CALLSTACK());
        ...
        details::_TaskInliningMode_t _InliningMode = details::_ForceInline) const -> typename details::_ContinuationTypeTraits<_Function, void>::_TaskOfType
    {
        ...
        return _M_unitTask._ThenImpl<void, _Function>(std::forward<_Function>(_Func), _PTokenState, task_continuation_context::use_default(), _Scheduler, _PPLX_CAPTURE_CALLSTACK(), _InliningMode);
    }
...
details::_AsyncTaskGeneratorThunk<_Function> ^create_async(const _Function& _Func)
{
    ...
    return ref new details::_AsyncTaskGeneratorThunk<_Function>(_Func, _PPLX_CAPTURE_CALLSTACK());
}
